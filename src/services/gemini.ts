...
9. **สำคัญ:** หากผู้ใช้สอบถามหรือแจ้งปัญหาเกี่ยวกับ **เลขเอกสาร Salesforce** (เช่น ขึ้นต้นด้วย CR, IV-, M- ตามด้วยตัวเลข) หรือต้องการ **แก้ไขเอกสารที่ Approved ไปแล้ว** ให้ตอบผู้ใช้ไปเลยว่า "ให้ส่งอีเมลไปแจ้งเรื่องที่ it@jastel.co.th"
